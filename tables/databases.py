sdfrom collections import namedtuple
import sqlite3
...
def query_list():
    for l in links:
        if l.id == 24 and l.submitter_id == 48626:
            return l
...
# query for all entries with > 500 votes
# def query_votes():
#     c = db.execute("SELECT * FROM links WHERE votes > 500")
#     for link_tuple in c:
#         link = Link(*link_tuple)
#         print "title: " + link.title + " votes: " + str(link.votes)
#
# print
# print "Entries with over 500 votes"
# query_votes()
